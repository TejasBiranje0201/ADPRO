               ...
               <div class="card shadow-lg">
                  <div class="card-body p-4">
                     ...
                     <div class="d-flex justify-content-between gap-md-5 mt-4">
                        <a href="../password-reminder/index.htm" class="btn-link text-decoration-none">Forgot password ?</a>
                        <a href="../register/index.htm" class="btn-link text-decoration-none">Create a new account</a>
                     </div>

  ...
  const handleSubmitGstData = async (e) => {
    ...
    if (!id) {
      try {
        ...
        setGst({ title: "", gstCode: "", cgstPercent: "", sgstPercent: "", igstPercent: "", agencyId: "" }); // Clear form
      } catch (error) {
      ...
      <main id="main" className="main">
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form onSubmit={handleSubmitGstData}>
                ...
                {/* <!-- Third Row: Agency Dropdown --> */}
                {/* <div class="row mb-3">
                  <div className="col-md-6">
                    <label for="agency" class="form-label fw-bold">Agency <span class="text-danger">*</span></label>
                    <select onChange={handleChangeGstData} value={gst.agencyId} name="agencyId" class="form-select" id="agency" >
        ...
        <div className="container mt-5">
          <div className="card shadow-lg">
            <div className="card-header bg-white text-center my-3">
              <h5 className="fw-bold">Tax Planning List</h5>
            </div>

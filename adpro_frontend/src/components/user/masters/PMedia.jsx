    ...
    const handleSubmitPmediaData = async (e) => {
        ...
        if (!id) {
            try {
                ...
                setPmedia({ name: "", contact: "", address: "", stateId: "", gstNo: "", agencyId: "" }); // Clear form
            } catch (error) {
                            ...
                            <form onSubmit={handleSubmitPmediaData}>
                                ...
                                {/* <div className="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select onChange={handleChangePmediaData} value={pmedia.agencyId} name="agencyId" class="form-select" id="agency" >
                ...
                <div class="container mt-5">
                    <div class="card shadow-lg">
                        <div class="card-header bg-white text-center my-3">
                            <h5 class="fw-bold">P-Media List</h5>
                        </div>
                        <div class="card-body">
